...
const Map<String, String> _rulePoemExcerpts = {
  'izhar_halqi':
      'فَالأَوَّلُ الإِظْهَارُ قَبْلَ أَحْرُفٍ لِلْحَلْقِ سِتٌّ رُتِّبَتْ فَلْتُعْرَفِ',
  'idgham_ghunnah':
      'وَالثَّانِي إِدْغَامٌ بِسِتَّةٍ أَتَتْ فِي يَرْمَلُونَ عِنْدَهُمْ قَدْ ثَبَتَتْ',
  'idgham_no_ghunnah':
      'لَكِنَّهَا قِسْمَانِ: قِسْمٌ بِغُنَّةٍ بِيَنْمُو، وَقِسْمٌ بِغَيْرِ غُنَّةٍ فِي اللَّامِ وَالرَّا',
  'iqlab':
      'وَالثَّالِثُ الإِقْلَابُ عِنْدَ الْبَاءِ مِيمًا بِغُنَّةٍ مَعَ الإِخْفَاءِ',
  'ikhfa_haqiqi':
      'وَالرَّابِعُ الإِخْفَاءُ عِنْدَ الْفَاضِلِ مِنَ الْحُرُوفِ وَاجِبٌ لِلْفَاضِلِ',
  ...
  'lam_shamsiyah':
      'وَثَانِيهِمَا إِدْغَامُهَا فِي أَرْبَعٍ وَعَشْرَةٍ أَيْضًا وَرَمْزُهَا فَتَرَعِ',
  ...
  'idgham_mutajanisain_sagheer':
      'وَإِنْ يَكُونَا مَخْرَجًا تَقَارَبَا وَفِي الصِّفَاتِ اخْتَلَفَا مُتَجَانِسَا',
  'idgham_mutaqaribain_sagheer':
      'وَإِنْ يَكُونَا فِي الْمَخَارِجِ اقْتَرَبَا وَفِي الصِّفَاتِ اتَّفَقَا مُتَقَارِبَا',
  'mad_asli':
      'وَالْمَدُّ أَصْلِيٌّ وَفَرْعِيٌّ لَهُ ... أَوَّلًا طَبِيعِيًّا وَهُوَ مَا لَا تَوَقُّفَ لَهُ عَلَى سَبَبْ',
  'mad_muttasil':
...
String rulePoemExcerptById(String ruleId) => _rulePoemExcerpts[ruleId] ?? '';
