...
const Map<String, List<String>> _rulePoemExcerpts = {
  'izhar_halqi': [
    'فَالأَوَّلُ الإِظْهَارُ قَبْلَ أَحْرُفٍ',
    'لِلْحَلْقِ سِتٌّ رُتِّبَتْ فَلْتُعْرَفِ',
  ],
  'idgham_ghunnah': [
    'وَالثَّانِي إِدْغَامٌ بِسِتَّةٍ أَتَتْ',
    'فِي يَرْمَلُونَ عِنْدَهُمْ قَدْ ثَبَتَتْ',
    'لَكِنَّهَا قِسْمَانِ قِسْمٌ يُدْغَمَا',
    'فِيهِ بِغُنَّةٍ بِيَنْمُو عُلِمَا',
  ],
  'idgham_no_ghunnah': [
    'وَالثَّانِي إِدْغَامٌ بِسِتَّةٍ أَتَتْ',
    'فِي يَرْمَلُونَ عِنْدَهُمْ قَدْ ثَبَتَتْ',
    'إِلَّا إِذَا كَانَا بِكِلْمَةٍ فَلَا',
    'تُدْغِمْ كَدُنْيَا ثُمَّ صِنْوَانٍ تَلَا',
    'وَالثَّانِي إِدْغَامٌ بِغَيْرِ غُنَّةٍ',
    'فِي اللَّامِ وَالرَّا ثُمَّ كَرِّرَنَّهْ',
  ],
  'iqlab': [
    'وَالثَّالِثُ الإِقْلَابُ عِنْدَ الْبَاءِ',
    'مِيمًا بِغُنَّةٍ مَعَ الإِخْفَاءِ',
  ],
  'ikhfa_haqiqi': [
    'وَالرَّابِعُ الإِخْفَاءُ عِنْدَ الْفَاضِلِ',
    'مِنَ الْحُرُوفِ وَاجِبٌ لِلْفَاضِلِ',
  ],
  'ghunnah_on_mushaddad': [
    'وَغُنَّ مِيمًا ثُمَّ نُونًا شُدِّدَا',
    'وَسَمِّ كُلًّا حَرْفَ غُنَّةٍ بَدَا',
  ],
  'ikhfa_shafawi': ['وَأَخْفِيَنَّ الْمِيمَ إِنْ تَسْكُنْ لَدَى بَاءٍ'],
  'idgham_shafawi': ['وَأَدْغِمَنَّهَا فِي الْمِيمِ إِنْ مِثْلُهَا أَتَى'],
  'izhar_shafawi': ['وَأَظْهِرَنَّهَا عِنْدَ بَاقِي الْأَحْرُفِ'],
  'lam_qamariyah': [
    'لِلَامِ أَلْ حَالَانِ قَبْلَ الأَحْرُفِ',
    'أُولَاهُمَا إِظْهَارُهَا فَلْتَعْرِفِ',
  ],
  'lam_shamsiyah': [
    'وَثَانِيهِمَا إِدْغَامُهَا فِي أَرْبَعٍ',
    'وَعَشْرَةٍ أَيْضًا وَرَمْزُهَا فَتَرَعِ',
  ],
  'lam_fiil_izhar': ['وَلَامُ فِعْلٍ أَظْهِرَنْ فِي كُلِّ حَالٍ'],
  'idgham_mutamathilain_sagheer': [
    'إِنْ فِي الصِّفَاتِ وَالْمَخَارِجِ اتَّفَقْ',
    'حَرْفَانِ فَالْمِثْلَانِ فِيهِمَا أَحَقْ',
  ],
  'idgham_mutajanisain_sagheer': [
    'وَإِنْ يَكُونَا مَخْرَجًا تَقَارَبَا',
    'وَفِي الصِّفَاتِ اخْتَلَفَا مُتَجَانِسَا',
  ],
  'idgham_mutaqaribain_sagheer': [
    'وَإِنْ يَكُونَا فِي الْمَخَارِجِ اقْتَرَبَا',
    'وَفِي الصِّفَاتِ اتَّفَقَا مُتَقَارِبَا',
  ],
  'mad_asli': [
    'وَالْمَدُّ أَصْلِيٌّ وَفَرْعِيٌّ لَهُ',
    'وَسَمِّ أَوَّلًا طَبِيعِيًّا وَهُوَ',
    'مَا لَا تَوَقُّفَ لَهُ عَلَى سَبَبْ',
    'وَلَا بِدُونِهِ الْحُرُوفُ تُجْتَلَبْ',
  ],
  'mad_muttasil': [
    'فَذُو اتِّصَالٍ أَوْ ذُو انْفِصَالٍ وَكِلَاهُمَا يُسَمَّى فَرْعِيًّا',
  ],
  'mad_munfasil': [
    'وَجَائِزٌ مَدٌّ وَقَصْرٌ إِنْ فُصِلْ',
    'كُلٌّ بِكِلْمَةٍ وَهَذَا الْمُنْفَصِلْ',
  ],
  'mad_badal': ['وَالْبَدَلُ كَهَمْزٍ قَبْلَ مَدٍّ'],
  'mad_arid_lissukun': [
    'وَعَارِضُ السُّكُونِ يَظْهَرُ عِنْدَ الْوَقْفِ فَيُمْدُّ',
  ],
  'mad_layyin': [
    'وَلِينُهُ فِي وَاوٍ وَيَاءٍ سَاكِنَيْنِ بَعْدَ فَتْحٍ عِنْدَ الْوَقْفِ',
  ],
  'mad_lazim': [
    'وَلَازِمٌ إِنِ السُّكُونُ أُصِّلَا',
    'وَصْلًا وَوَقْفًا بَعْدَ مَدٍّ طُوِّلَا',
  ],
  'mad_lazim_kalimi_muthaqal': [
    'فَكِلْمِيٌّ ذُو ثِقَلٍ إِنْ أُدْغِمَا بَعْدَ الْمَدِّ',
  ],
  'mad_lazim_kalimi_mukhaffaf': [
    'وَكِلْمِيٌّ مُخَفَّفٌ إِنْ لَمْ يَكُنْ بَعْدَ الْمَدِّ إِدْغَامٌ',
  ],
  'mad_lazim_harfi_muthaqal': [
    'وَحَرْفِيٌّ كَذَاكَ مُثَقَّلٌ فِي فَوَاتِحِ السُّوَرِ',
  ],
  'mad_lazim_harfi_mukhaffaf': ['وَحَرْفِيٌّ مُخَفَّفٌ فِي نَحْوِ ق وَن'],
  'mad_fawatih_natural': [
    'وَمَا سِوَى الْحَرْفِ الثُّلَاثِيِّ فِي الْفَوَاتِحِ فَمَدُّهُ طَبِيعِيٌّ',
  ],
};

List<String> rulePoemExcerptsById(String ruleId) =>
    _rulePoemExcerpts[ruleId] ?? const [];
